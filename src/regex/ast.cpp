...
character_set_branch::character_set_branch() : branch(), characters() {

}

character_set_branch::character_set_branch(const std::vector<char_range>& characters)
 : branch(), characters(characters) {
